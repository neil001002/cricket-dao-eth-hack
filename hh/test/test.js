const main = async () => {
  ...
  let txn = await cricketDaoNFTContract.claim(7);
  await txn.wait();
  console.log("Minted NFT with ID 7");
  ...
  const ownerOf = await cricketDaoNFTContract.ownerOf(7);
  await txn.wait();
  console.log("Owner of token id 7 = ", ownerOf);
